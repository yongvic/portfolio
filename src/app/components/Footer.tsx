...
const Footer = () => {
  return (
    <footer className="bg-[#11011B] border-t border-pink-500/20 text-gray-400 py-8">
      <div className="container mx-auto text-center">
        <p className="text-2xl font-bold text-white mb-4">SOKPA Edo Yawo</p>
        ...
        <div className="flex justify-center space-x-6 mb-6 text-sm">
          <Link href="/#projects" className="hover:text-pink-400 transition-colors">Projets</Link>
